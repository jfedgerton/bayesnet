...
#' @param formula.stage.2 the formula for the second stage model
#' @param net the input network
#' @param chains number of chains for estimation
#' @param warmup number of warmup steps for estimation
#' @param iter number of interactions for the sampler
#' @param cores number of cores used for estimation
#' @param seed the starting position for analysis
